...
class ProductOrderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:ProductOrder')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:ProductOrder:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:ProductOrder')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:ProductOrder:edit.html.twig")
     */
